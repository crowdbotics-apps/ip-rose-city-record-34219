...
## Project Structure
    ...
    ├── ip_rose_city_record_34219  # Django project configurations
...
1. Clone this repo and `cd ip_rose_city_record_34219`
...
2. Clone this repo and `cd ip_rose_city_record_34219`
